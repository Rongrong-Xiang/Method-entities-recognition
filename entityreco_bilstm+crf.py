...
class BiLSTM_CRF(nn.Module):
    def __init__(self, vocab_size, embedding_dim, hidden_dim, num_labels, pad_token_id):
...
def train_one_fold(train_idx, val_idx, all_samples):
    ...
    model = BiLSTM_CRF(vocab_size, embedding_dim, hidden_dim, num_labels=len(label2id), pad_token_id=pad_token_id)
    model.to(device)
...
if __name__ == '__main__':
    all_samples = load_jsonl_data("/workspace/Innovation_method_202503/input_data/3_method_train.jsonl")
